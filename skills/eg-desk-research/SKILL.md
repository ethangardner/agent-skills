...
1. **Keep the exploratory trail.** Unlike production work, the versioned
   ...
   history, `eg-change-documentation-rigor` still says to keep exploration out.
...
production work, and `eg-change-documentation-rigor` (keep exploration out of
